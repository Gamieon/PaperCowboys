...
public class Character : SynchronizedObject
{
	...
	/// <summary>
	/// True if the character is crouching and the character belongs to ourselves (myNetworkView.isMine is true)
	/// </summary>
	protected bool crouchActive;
	
	/// <summary>
	/// True if the player is walking upwards and the character belongs to ourselves (myNetworkView.isMine is true).
	/// </summary>
	protected bool walkUpActive;	

	/// <summary>
	/// True if the player is walking downwards and the character belongs to ourselves (myNetworkView.isMine is true).
	/// </summary>
	protected bool walkDownActive;	
	
	/// <summary>
	/// True if the player is walking left and the character belongs to ourselves (myNetworkView.isMine is true)
	/// </summary>
	protected bool walkLeftActive;

	/// <summary>
	/// True if the player is walking right and the character belongs to ourselves (myNetworkView.isMine is true)
	/// </summary>
	...
	protected override void Update()
	{
		...
		if (IsDying)
		{
			...
			if (tryToUnspawn && myNetworkView.isMine)
			{
