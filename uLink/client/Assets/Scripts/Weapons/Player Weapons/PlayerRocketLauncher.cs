...
/// <summary>
/// Player rocket launcher behavior
/// </summary>
public class PlayerRocketLauncher : PlayerWeapon, IWeapon
{
	const string bulletPrefabName = "Rocket";
	...
	void IWeapon.BeginFiringPrimary(WeaponFiringDirection firingDirection, Color color)
	{
		...
		float launchForceMagnitude = 22.0f;
